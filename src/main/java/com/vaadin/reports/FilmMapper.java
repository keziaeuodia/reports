...
public interface FilmMapper {
    ...
    String ADD_NEW_FILMS = "INSERT INTO film(title, description, language_id, rating) " +
            "SELECT f.film_id, f.title, f.description, f.release_year, l.name as `language`, f.length, f.rating " +
